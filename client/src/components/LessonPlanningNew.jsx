...
export default function LessonPlanningNew({ onAddToPlan }) {
  ...
  // 1️⃣ Load parts (for now just logs the message)
  useEffect(() => {
  ...
  return (
    <div className="lesson-page">
      {/* Sidebar placeholder (match NewLessonPart) */}
      <aside className="lesson-sidebar">Sidebar</aside>

      <div className="new-lesson-page lesson-planning-new flex h-full overflow-hidden">
        {/* Left panel: “Current Lesson” */}
