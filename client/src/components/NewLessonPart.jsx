...
export default function NewLessonPart() {
  ...
  const handleSave = async () => {
    ...
    setSaving(true);
    try {
      const res = await fetch('/api/lesson_parts', {
        method: 'POST',
        body: form,
      });
  ...
  return (
    <div className="flex h-full overflow-hidden bg-gray-50 dark:bg-dark-900 transition-colors duration-200">
      {/* Sidebar */}
